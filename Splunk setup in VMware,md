...
## **Objective**  
The objective of this task is to help students **install and configure Splunk on an Kali machine**. By completing this task, students will have Splunk up and running to collect and analyze security logs.

---

## **Lab Setup**  
### **Requirements**  
- **System:** Kali Linux 2025.4 (Server or Desktop)  
- **Tools Required:**  
...
## **Steps to Install and Configure Splunk on Kali Linux **
